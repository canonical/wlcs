...
public:
    ...
    Impl(Client& client, Surface* parent, Surface* surface)
...
wlcs::Subsurface::Subsurface(Client& client, Surface* parent)
    : Surface(client),
      impl{std::make_unique<Impl>(client, parent, this)}
{}
...
void wlcs::Subsurface::set_offset(int x, int y)
{
